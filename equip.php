		...
		<img src="pic.png">
			...
			<div class="top">
				...
				if(isset($_SESSION['username'])){ ?>
					...
					<?php echo "Usertype: " . $_SESSION['usertype']; ?> 
					</div>
				<?php
				}
				else{
				...
				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					...
					<a href="create-eq.php">Add new Equipment</a><br>
					...
					<a href="tech.php" style="margin:10px;">Equipment Table</a>
					</div>
				</form>
				<center>
				<?php
				function build_table($result){
					if(mysqli_num_rows($result) > 0){
						...
						while($row = mysqli_fetch_array($result)){
							...
							echo "<td>";
							echo "<a href = 'update-eq.php?serialnum=" . $row['serialnum'] . "'>Update </a>";
							echo "<a href = 'delete-eq.php?serialnum=" . $row['serialnum'] . "'>Delete</a>";
